...
class InfrastructureFile implements GenFile {
	...
	{
		$this->templatePath    = $projectPath.'/script/template/Infrastructure/ModuleRepository.txt';
		$this->destinationPath = $projectPath.'/src/'.$configs['name'].'/'.$directories['infrastructure'].'/'.$configs['module'].'Repository.php';
